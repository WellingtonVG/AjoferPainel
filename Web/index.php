            ...
            <section class="cabecalhoB">
              ...
              <section id="subtitulo">
                ...
                <section class="sec2" id="sec2">
                  <div class="btnA">
                    <button onclick="gotofrota()" id="btFrota">Frota</button>
                  </div>
                  <div class="btnB">
            ...
            <section class="Lside" id="LadoA">
              ...
              <section id="cabecalhoLadoA">
                  ...
                  <section class="selecMES comboninja">
                    ...
                    <!--cabelçalho opçoes B-->
                  <section class="selecCLIENTE comboninja2">
                    ...
                    <form name="form2">
                      <select  name="cliente" id="cliente">
                        ...
                        <option value="0">TODOS</option>
                        <?php
                              $result_painel = "SELECT distinct cliente_fat from painelajofer order by cliente_fat";
                              $resultado_niveis_acesso = mysqli_query($conn, $result_painel);
                              while($row_painelajofer = mysqli_fetch_assoc($resultado_niveis_acesso)){ ?>
                                <option value="<?php echo $row_painelajofer['cliente_fat']; ?>"><?php echo $row_painelajofer['cliente_fat']; ?></option> <?php
                              }
                            ?>
                      </select>
                    </form>
